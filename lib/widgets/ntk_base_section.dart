...
class NtkBaseSection extends StatefulWidget {
  final String title;
  final bool isOpen;
  ...
  @override
  State<NtkBaseSection> createState() => _NtkBaseSectionState();
}

class _NtkBaseSectionState extends State<NtkBaseSection> {
  bool _isOpen = true;
  ...
  @override
  void didUpdateWidget(covariant NtkBaseSection oldWidget) {
